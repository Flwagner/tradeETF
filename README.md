...
`SUPABASE_ACCESS_TOKEN` est un token personnel Supabase utilisé uniquement par GitHub Actions pour exécuter `supabase functions deploy --project-ref nfnkrzgvziepxwdikiuw`. Activer ensuite GitHub Pages avec la source “GitHub Actions”.
